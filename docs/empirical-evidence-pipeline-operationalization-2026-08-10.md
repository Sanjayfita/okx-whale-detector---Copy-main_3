...
OKX public book/trades/candles
  ...
  -> OKXLivePriceReader at nine frozen horizons
...
| Outcome recovery          | `persistentOutcomeScheduler`, `liveEvidenceCollector`, `okxLivePriceReader`                                                                                                 | Operational; nine horizons, atomic state, idempotent reconciliation, durable missed-window states, sampled raw paths, and restart recovery.                                                              |
